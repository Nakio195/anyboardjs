...
(function(){
    ...
    cypawnBluetooth._COMMANDS = {
        ...
        GET_COLOR: cypawnBluetooth._GenericSend(
            ...
            NO_PARAMS),
        MOVE: cypawnBluetooth._GenericSend(
            "MOVE",
            cypawnBluetooth._CMD_CODE.MOVE,
            NO_PARAMS)
    };
    ...
    cypawnBluetooth.move = function (token, win, fail) {
        this._COMMANDS.MOVE(token, win, fail);
        ...
        var handleReceiveUpdateFromToken = function(uint8array) {
            ...
            switch (command) {
                ...
                case cypawnBluetooth._CMD_CODE.GET_COLOR:
                    ...
                    token.trigger('GET_COLOR', {"value": uint8array[1]});
                    break;
                default:
