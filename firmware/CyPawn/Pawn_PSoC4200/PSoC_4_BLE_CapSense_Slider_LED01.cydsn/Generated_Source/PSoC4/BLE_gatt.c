...
CYBLE_STATE_T cyBle_state;
    ...
    #endif  /* (__ARMCC_VERSION) */
    {
        ...
        {{
            0x00u, 0x00u, 
            0x00u, 0x00u, 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u, 0x00u, 0x10u, 0x00u, 0x00u, 0x01u, 0x29u, 0x00u,
        0x00u, 
        },
        {
            0x00u, 0x00u, 
...
(uint8)'n', (uint8)'t', (uint8)'r', (uint8)'o', (uint8)'l', 0xFBu, 0x34u, 0x9Bu, 0x5Fu, 0x80u, 0x00u, 0x00u, 0x80u,
0x00u, 0x10u, 0x00u, 0x00u, 0x02u, 0x29u, 0x00u, 0x00u, 
...
const uint8 cyBle_attUuid128[][16u] = {
    /* RGB LED */
    { 0xDEu, 0x74u, 0x2Du, 0xF0u, 0x70u, 0x13u, 0x12u, 0xB5u, 0x44u, 0x4Bu, 0xB1u, 0xC5u, 0x10u, 0xFFu, 0x95u, 0xA4u },
    /* RGB LED Control */
    { 0xDEu, 0x74u, 0x2Du, 0xF0u, 0x70u, 0x13u, 0x12u, 0xB5u, 0x44u, 0x4Bu, 0xB1u, 0xC5u, 0x11u, 0xFFu, 0x95u, 0xA4u },
};
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x0004u, (void *)&cyBle_attValues[20] }, /* RGB LED Control */
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x10u] = {
    ...
    { 0x000Eu, 0xff11u /* RGB LED Control                     */, 0x00091A04u /* rd,wr,ntf */, 0x0010u, {{0x0004u, (void *)&cyBle_attValuesLen[7]}} },
    { 0x000Fu, 0x2901u /* Client Characteristic Configuration */, 0x00090004u /*           */, 0x000Fu, {{0x0002u, (void *)&cyBle_attValuesLen[8]}} },
    { 0x0010u, 0x2902u /* Characteristic User Description     */, 0x00090201u /* rd        */, 0x0010u, {{0x000Fu, (void *)&cyBle_attValuesLen[9]}} },
};
