...
#define CYBLE_RGB_LED_RGB_LED_CONTROL_DECL_HANDLE   (0x000Du) /* Handle of RGB LED Control characteristic declaration */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHAR_HANDLE   (0x000Eu) /* Handle of RGB LED Control characteristic */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x000Fu) /* Handle of Client Characteristic Configuration descriptor */
#define CYBLE_RGB_LED_RGB_LED_CONTROL_CHARACTERISTIC_USER_DESCRIPTION_DESC_HANDLE   (0x0010u) /* Handle of Characteristic User Description descriptor */
