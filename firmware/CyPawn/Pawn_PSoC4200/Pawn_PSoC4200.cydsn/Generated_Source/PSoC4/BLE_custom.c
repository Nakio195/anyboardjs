...
const CYBLE_CUSTOMS_T cyBle_customs[0x02u] = {
    ...
    {
        0x000Au, /* Handle of the CyPawn AnyBoardJS service */ 
        {

            /* Pawn Info characteristic */
            {
                0x000Cu, /* Handle of the Pawn Info characteristic */ 
                
                /* Array of Descriptors handles */
                {
                    0x000Du, /* Handle of the Version descriptor */ 
