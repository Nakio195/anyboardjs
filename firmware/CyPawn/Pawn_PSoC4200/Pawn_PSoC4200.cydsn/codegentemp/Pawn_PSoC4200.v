// ======================================================================
// Pawn_PSoC4200.v generated from TopDesign.cysch
// 01/15/2017 at 20:33
...
`ifdef WARP
`define CY_BLK_DIR "F:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "F:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "F:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0"
`include "F:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cyprimitives\CyPrimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d3071de4-b101-4dd4-b6e7-fb07b622a779"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("66e828f7-eeca-4675-9826-381072c33d92"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c8eb6d6e-9fe1-498d-85dd-e88473be8e04"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_W_net;
	wire [0:0] tmpFB_0__LED_W_net;
	wire [0:0] tmpIO_0__LED_W_net;
	wire [0:0] tmpINTERRUPT_0__LED_W_net;
	electrical [0:0] tmpSIOVREF__LED_W_net;

	cy_psoc3_pins_v1_10
		#(.id("8d759fe8-607a-4a3d-b3c5-3d1bca1cab1a"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		LED_W
		 (.oe(tmpOE__LED_W_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_W_net[0:0]}),
		  .io({tmpIO_0__LED_W_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_W_net),
		  .interrupt({tmpINTERRUPT_0__LED_W_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_W_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
