...
#define CYBLE_CYPAWN_ANYBOARDJS_SERVICE_INDEX   (0x00u) /* Index of CyPawn AnyBoardJS service in the cyBle_customs array */
...
#define CYBLE_CYPAWN_ANYBOARDJS_PAWN_INFO_DECL_HANDLE   (0x000Bu) /* Handle of Pawn Info characteristic declaration */
